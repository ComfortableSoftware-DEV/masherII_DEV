...
MSEUPFULL = [IE(LD.EV_REL.REL_Y, -MOUSEDISTANCE), SYNREPORT]
MSEDNFULL = [IE(LD.EV_REL.REL_Y, MOUSEDISTANCE), SYNREPORT]
MSELTFULL = [IE(LD.EV_REL.REL_X, -MOUSEDISTANCE), SYNREPORT]
MSERTFULL = [IE(LD.EV_REL.REL_X, MOUSEDISTANCE), SYNREPORT]

MSEWHLUPFULL = [IE(LD.EV_REL.REL_WHEEL, WHEELDISTANCE), SYNREPORT]
MSEWHLDNFULL = [IE(LD.EV_REL.REL_WHEEL, -WHEELDISTANCE), SYNREPORT]
MSEWHLLTFULL = [IE(LD.EV_REL.REL_HWHEEL, -WHEELDISTANCE), SYNREPORT]
MSEWHLRTFULL = [IE(LD.EV_REL.REL_HWHEEL, WHEELDISTANCE), SYNREPORT]
...
MSEWHLUPHRFULL = [IE(LD.EV_REL.REL_WHEEL_HI_RES, WHEELDISTANCE), SYNREPORT]
MSEWHLDNHRFULL = [IE(LD.EV_REL.REL_WHEEL_HI_RES, -WHEELDISTANCE), SYNREPORT]
MSEWHLLTHRFULL = [IE(LD.EV_REL.REL_HWHEEL_HI_RES, -WHEELDISTANCE), SYNREPORT]
MSEWHLRTHRFULL = [IE(LD.EV_REL.REL_HWHEEL_HI_RES, WHEELDISTANCE), SYNREPORT]
